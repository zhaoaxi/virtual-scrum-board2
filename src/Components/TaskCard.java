...
public class TaskCard {
    ...
    public TaskCard(ProjectScreen parent, int ticketID){
        ...
        taskCard.setBackground(taskCardColor);
    ...
    public TaskCard(ProjectScreen parent, int ticketID, Color color){
        this.ticketID = ticketID;
        this.taskCardColor = color;
        loadTask();
        loadStatus();
        loadDescription();
        ...
        taskCard = new JPanel();
        taskCard.setPreferredSize(new Dimension(440, 152));
        taskCard.setBackground(taskCardColor);  // 设置任务卡的背景颜色
        taskCard.setLayout(new FlowLayout(FlowLayout.LEFT, 0, 0));
        ...
        JLabel taskCardStatusIcon = FAicon(ticketStatus == TicketStatus.DONE ? "\uf00c" :
                (ticketStatus == TicketStatus.TO_DO ? "\uf0ae" : "\uf110"), 32, Colors.primaryBlue);
        taskCardStatusIcon.setPreferredSize(new Dimension(61, 38));
